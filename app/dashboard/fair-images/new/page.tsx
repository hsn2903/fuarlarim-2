...
import { createFairImage } from "@/app/_actions/fair-images";
...
export default function DashboardNewHotelPage() {
  return (
    <div className="container mx-auto py-8">
      ...
      <form action={createFairImage} className="flex flex-col gap-2">
        <FormInput
          label="Görsel Adı"
          name="name"
          type="text"
        ...
        <SubmitButton text="Fuar Görseli Oluştur" size="lg" />
      </form>
    </div>
  );
}
